...
TEST_NAME="TEST_GPU" #"negativeSamplesV2TOnePosPairsEpochs50NoBound"

THREADS=40
SEQ_MIN_LEN=3000
SAMPLES=( PaPr00000216MP ) #(PaPr00000216MP ASYM00000026MP) #(PaPr00000216MP RASK00000062MP ASYM00000026MP RASK00000098MP)
